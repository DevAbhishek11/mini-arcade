...
export const GAME_CATALOG: Record<GameId, GameCatalogEntry> = {
  ...
  chess: {
    id: 'chess',
    name: 'Chess',
    tagline: 'The whole game. Castling, en passant, the lot.',
    description:
      'Full tournament rules — castling, en passant, promotion, stalemate, the fifty move rule and dead positions. Legal moves are computed by the engine, so you can only ever play a real chess move.',
    mode: 'turn-based',
    players: 2,
    tickRate: 0,
    ...
    averageMinutes: 14,
    howTo: [
      'Tap a piece to see every legal move it has.',
      'Castle by moving the king two squares towards its rook.',
      'Pawns reaching the far rank promote — to a queen unless you pick otherwise.',
      'Checkmate wins; stalemate, fifty quiet moves or bare kings draw.',
    ],
  },
  sudoku: {
    id: 'sudoku',
    name: 'Sudoku Duel',
    tagline: 'One grid. Two solvers. Fastest eye wins.',
    description:
      'A real sudoku, played as a race. Take turns filling a digit: correct scores a point, wrong costs one. When the grid is full, the higher score takes the match.',
    mode: 'turn-based',
    players: 2,
    tickRate: 0,
    turnTimeoutMs: 45_000,
    ...
    averageMinutes: 9,
    howTo: [
      'Pick any empty cell, then the digit you believe belongs there.',
      'A correct digit scores a point and locks the cell in your colour.',
      'A wrong digit costs a point and hands over the turn.',
      'Most points when the grid is complete wins.',
    ],
  },
  bingo: {
    id: 'bingo',
    name: 'Bingo Blitz',
    tagline: 'Call the ball you need. Deny the one they do.',
    description:
      'Classic bingo with a twist: every ball marks both cards, and on your turn you choose which of three balls gets called. Suddenly luck has a steering wheel.',
    mode: 'turn-based',
    players: 2,
    tickRate: 0,
    turnTimeoutMs: 30_000,
    ...
    averageMinutes: 4,
    howTo: [
      'Each player gets a 5x5 card with a free centre square.',
      'On your turn, call one of the three offered balls.',
      'Every call marks both cards, so watch what you are giving away.',
      'First card to complete any row, column or diagonal wins.',
    ],
  },
  'nine-mens-morris': {
    id: 'nine-mens-morris',
    name: "Nine Men's Morris",
    tagline: 'Three in a row, then take one away.',
    description:
      'A strategy classic older than chess. Place nine pieces, slide them along the lines, and every mill you form takes an enemy piece off the board. Down to three pieces, you can fly anywhere.',
    mode: 'turn-based',
    players: 2,
    tickRate: 0,
    turnTimeoutMs: 40_000,
    ...
    averageMinutes: 8,
    howTo: [
      'Place your nine pieces one per turn on any empty point.',
      'Then slide a piece along a line to a neighbouring empty point.',
      'Line up three to form a mill and remove an enemy piece.',
      'Pieces inside a mill are safe unless every enemy piece is milled.',
      'Reduce your opponent to two pieces, or leave them with no move, to win.',
    ],
  },
};
